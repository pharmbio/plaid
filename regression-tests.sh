...
myUnitTestsResults=( '4 plates'
		     ...
		     'MiniZinc: evaluation error:'
		     '2 plates' #'pl-example04-jonne-doubled'
		     ...
		     '1 plates' '1 plates' '4 plates' #'2 plates' #'pl-example23'
		     '2 plates' '2 plates' '3 plates' '4 plates'
		     '2 plates' '1 plates'
		     'MiniZinc: evaluation error:' #'pl-example31'
		     '1 plates' #'pl-example35'
		     'MiniZinc: evaluation error:' #'pl-example36'
		     '1 plates'
		     #'1 plates' #'compounds-10-9-3'
		     '1 plates'
